...
public class ExampleGui extends Panel {
    ...
    private void createWidgetsWithSomeButtons() {
        ...
        Icon bgIm = new ImageIcon(ImageLoader.loadImage(new Identifier(Legui.ID, "demo/1.png")));
        bgIm.setSize(new Vector2f(20, 20));
        turnWidVisible.getStyle().getBackground().setIcon(bgIm);
        Icon hbgIm = new ImageIcon(ImageLoader.loadImage(new Identifier(Legui.ID, "demo/2.png")));
        hbgIm.setSize(new Vector2f(20, 20));
//        turnWidVisible.setHoveredBackgroundIcon(hbgIm);
        Icon pbIm = new ImageIcon(ImageLoader.loadImage(new Identifier(Legui.ID, "demo/3.png")));
...
//                widget3.setResizable(!widget3.isResizable());
    ...
    private Widget createImageWrapperWidgetWithImage() {
        ...
        imageView = new ImageView(ImageLoader.loadImage(new Identifier(Legui.ID, "demo/1.jpg")));
    ...
    private ToggleButton createToggleButtonWithLongTooltip() {
        ...
        Icon bgImageNormal = new ImageIcon(ImageLoader.loadImage(new Identifier(Legui.ID, "demo/toggle.png")));

...
public class Configuration {
    ...
    private static void initialize() {
        ...
        try {
            ...
            try {
                InputStream configStream = pack.open(ResourceType.CLIENT_RESOURCES, new Identifier(Legui.ID, "config.json"));
                String configBytes = IOUtil.resourceToString(configStream);
